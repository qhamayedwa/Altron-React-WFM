...
let AiService = AiService_1 = class AiService {
    ...
    model = 'gpt-4o';
    isAvailable;
    constructor(departmentRepo, leaveApplicationRepo, payCalculationRepo, roleRepo, scheduleRepo, shiftTypeRepo, timeEntryRepo, userRepo, userRoleRepo, configService, fallbackService) {
...
exports.AiService = AiService = AiService_1 = __decorate([
    ...
    __param(5, (0, typeorm_1.InjectRepository)(shift_type_entity_1.ShiftType)),
    __param(6, (0, typeorm_1.InjectRepository)(time_entry_entity_1.TimeEntry)),
    __param(7, (0, typeorm_1.InjectRepository)(user_entity_1.User)),
    __param(8, (0, typeorm_1.InjectRepository)(user_role_entity_1.UserRole)),
