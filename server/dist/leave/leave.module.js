...
exports.LeaveModule = LeaveModule = __decorate([
    (0, common_1.Module)({
        imports: [
            typeorm_1.TypeOrmModule.forFeature([leave_application_entity_1.LeaveApplication, leave_balance_entity_1.LeaveBalance, leave_type_entity_1.LeaveType, user_entity_1.User, department_entity_1.Department]),
