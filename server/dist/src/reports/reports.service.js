...
let ReportsService = class ReportsService {
    ...
    async getPayrollSummary(startDate, endDate, departmentId) {
        ...
        const totalHours = calculations.reduce((sum, calc) => sum + Number(calc.total_hours || 0), 0);
        const totalAllowances = calculations.reduce((sum, calc) => sum + Number(calc.total_allowances || 0), 0);
        return {
            success: true,
            calculations,
            summary: {
