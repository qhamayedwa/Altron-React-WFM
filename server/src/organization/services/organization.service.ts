...
export class OrganizationService {
  ...
  async updateCompany(id: number, dto: UpdateCompanyDto) {
    ...
    if (dto.name !== undefined) existingCompany.name = dto.name;
    if (dto.code !== undefined) existingCompany.code = dto.code;
    if (dto.legal_name !== undefined) existingCompany.legalName = dto.legal_name;
    if (dto.registration_number !== undefined) existingCompany.registrationNumber = dto.registration_number;
    if (dto.tax_number !== undefined) existingCompany.taxNumber = dto.tax_number;
    if (dto.email !== undefined) existingCompany.email = dto.email;
    if (dto.phone !== undefined) existingCompany.phone = dto.phone;
    if (dto.website !== undefined) existingCompany.website = dto.website;
    if (dto.address_line1 !== undefined) existingCompany.addressLine1 = dto.address_line1;
    if (dto.address_line2 !== undefined) existingCompany.addressLine2 = dto.address_line2;
    if (dto.city !== undefined) existingCompany.city = dto.city;
    if (dto.state_province !== undefined) existingCompany.stateProvince = dto.state_province;
    if (dto.postal_code !== undefined) existingCompany.postalCode = dto.postal_code;
    if (dto.country !== undefined) existingCompany.country = dto.country;
    if (dto.timezone !== undefined) existingCompany.timezone = dto.timezone;
    if (dto.currency !== undefined) existingCompany.currency = dto.currency;
    if (dto.fiscal_year_start !== undefined) existingCompany.fiscalYearStart = dto.fiscal_year_start;
    if (dto.is_active !== undefined) existingCompany.isActive = dto.is_active;
  ...
  async updateRegion(id: number, dto: UpdateRegionDto) {
    ...
    if (dto.description !== undefined) region.description = dto.description;
    if (dto.manager_name !== undefined) region.managerName = dto.manager_name;
    if (dto.email !== undefined) region.email = dto.email;
    if (dto.phone !== undefined) region.phone = dto.phone;
    if (dto.address_line1 !== undefined) region.addressLine1 = dto.address_line1;
    if (dto.address_line2 !== undefined) region.addressLine2 = dto.address_line2;
    if (dto.city !== undefined) region.city = dto.city;
    if (dto.state_province !== undefined) region.stateProvince = dto.state_province;
    if (dto.postal_code !== undefined) region.postalCode = dto.postal_code;
    if (dto.timezone !== undefined) region.timezone = dto.timezone;
    if (dto.is_active !== undefined) region.isActive = dto.is_active;
  ...
  async deleteRegion(id: number) {
    ...
    if (activeSites.length > 0) {
      throw new BadRequestException(
        `Cannot delete region: ${activeSites.length} active sites still exist. Please deactivate or move sites first.`
      );
    }
  ...
  async updateSite(id: number, dto: UpdateSiteDto) {
    ...
    if (dto.code !== undefined) site.code = dto.code;
    if (dto.site_type !== undefined) site.siteType = dto.site_type;
    if (dto.description !== undefined) site.description = dto.description;
    if (dto.manager_name !== undefined) site.managerName = dto.manager_name;
    if (dto.email !== undefined) site.email = dto.email;
    if (dto.phone !== undefined) site.phone = dto.phone;
    if (dto.address_line1 !== undefined) site.addressLine1 = dto.address_line1;
    if (dto.address_line2 !== undefined) site.addressLine2 = dto.address_line2;
    if (dto.city !== undefined) site.city = dto.city;
    if (dto.state_province !== undefined) site.stateProvince = dto.state_province;
    if (dto.postal_code !== undefined) site.postalCode = dto.postal_code;
    if (dto.latitude !== undefined) site.latitude = dto.latitude;
    if (dto.longitude !== undefined) site.longitude = dto.longitude;
    if (dto.geo_fence_radius !== undefined) site.geoFenceRadius = dto.geo_fence_radius;
    if (dto.operating_hours_start !== undefined) site.operatingHoursStart = dto.operating_hours_start ? new Date(`1970-01-01T${dto.operating_hours_start}`) : undefined;
    if (dto.operating_hours_end !== undefined) site.operatingHoursEnd = dto.operating_hours_end ? new Date(`1970-01-01T${dto.operating_hours_end}`) : undefined;
    if (dto.timezone !== undefined) site.timezone = dto.timezone;
    if (dto.allow_remote_work !== undefined) site.allowRemoteWork = dto.allow_remote_work;
    if (dto.is_active !== undefined) site.isActive = dto.is_active;
  ...
  async updateDepartment(id: number, dto: UpdateDepartmentDto) {
    ...
    if (dto.cost_center !== undefined) department.costCenter = dto.cost_center;
    if (dto.budget_code !== undefined) department.budgetCode = dto.budget_code;
    if (dto.manager_id !== undefined) department.managerId = dto.manager_id;
    if (dto.deputy_manager_id !== undefined) department.deputyManagerId = dto.deputy_manager_id;
    if (dto.email !== undefined) department.email = dto.email;
    if (dto.phone !== undefined) department.phone = dto.phone;
    if (dto.extension !== undefined) department.extension = dto.extension;
    if (dto.standard_hours_per_day !== undefined) department.standardHoursPerDay = dto.standard_hours_per_day;
    if (dto.standard_hours_per_week !== undefined) department.standardHoursPerWeek = dto.standard_hours_per_week;
    if (dto.is_active !== undefined) department.isActive = dto.is_active;
